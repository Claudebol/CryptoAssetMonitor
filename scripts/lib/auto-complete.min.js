    ...
    if (document.querySelector) {
      var l = {
        ...
        renderItem: function (e, t) {
          ...
          return '<div class="autocomplete-suggestion" data-val="">' + e.replace(o, "<b>$1</b>") + "</div>"
        },
        onSelect: function () {
        }
      };
      ...
      for (var a = "object" == typeof l.selector ? [l.selector] : document.querySelectorAll(l.selector), u = 0; u < a.length; u++) {
        ...
        }, o(window, "resize", i.updateSC), document.body.appendChild(i.sc), i.blurHandler = function () {
          try {
